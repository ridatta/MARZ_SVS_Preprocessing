function Hg = importfile1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   HG = IMPORTFILE1(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   HG = IMPORTFILE1(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Hg = importfile1('Hg.txt', 7, 125);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2022/07/18 14:21:13
